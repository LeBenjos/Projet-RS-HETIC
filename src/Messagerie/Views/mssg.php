...
<body>
    ...
    <div class="section">
        <div class="sidebar">
            <div>
                <h3>Conversations</h3>
                <?php foreach ([[1, "Marie", "Message reçu"], [2, "Julien", "Inbox"], [3, "Gwen", "Message"], [4, "Louisan", "Reçu"]] as list($id, $name, $message)) { ?>
                <a href="http://localhost:8888/Views/mssg.php?id=<?php echo $id ?>" class="conversation">
